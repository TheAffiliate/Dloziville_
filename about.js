// about.js
// All JavaScript logic from <script> in about.html moved here.
// External scripts (Appwrite, Tailwind) should still be loaded via <script src> in the HTML.
// This file assumes those libraries are available globally.
